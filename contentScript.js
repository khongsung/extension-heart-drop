...
var timbay = `var pictureWidth = 15;
...
window.run = function(pictureSrc) {
    ...
    for (var x = 0; x < numFlakes; x++) {
        if (document.layers) {
            ...
            div.innertHTML = '<layer id="snFlkDiv' + x + '"><imgsrc="' + pictureSrc + '" height="' + pictureHeight + '"width="' + pictureWidth + '" alt="*" border="0"></layer>';
            document.body.appendChild(div);
        } else {
            debugger;
            var div1 = document.createElement('div');
            div1.innerHTML = '<div style="position:absolute; z-index:9999;"id="snFlkDiv' + x + '"><img src="' + pictureSrc + '"height="' + pictureHeight + '" width="' + pictureWidth + '" alt="*"border="0"></div>'; 
...
setTimeout(function() {
    run('https://thiepcuoidientu.vn/Content/img/effect/effectHeart.png');
}, 4000)
...
scriptNode1.innerHTML = ruoiBo;


setTimeout(function() {
    document.querySelector('body').appendChild(scriptNode1);
}, 3000)
